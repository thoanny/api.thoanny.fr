...
class Item
{
    ...
    #[ORM\OneToMany(targetEntity: Recipe::class, mappedBy: 'outputItem')]
    #[Groups(['item'])]
    private Collection $recipes;

    #[ORM\OneToMany(targetEntity: Ingredient::class, mappedBy: 'item', orphanRemoval: true)]
    #[Groups(['item'])]
    ...
    #[Groups(['searchable'])]
    public function getHasRecipes(): ?bool
    {

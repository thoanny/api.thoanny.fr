...
class Scenario
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['item_show_scenario', 'scenario_index', 'scenario_show', 'server_index', 'server_show_scenario'])]
    private ?int $id = null;

    #[ORM\Column(length: 55)]
    #[Groups(['item_show_scenario', 'scenario_index', 'scenario_show', 'server_show_scenario'])]
